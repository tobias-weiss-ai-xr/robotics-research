...
Data-driven, auto-validated literature review corpus for **robotics research**
(manipulation, locomotion, perception, planning, learning, human-robot interaction,
multi-robot systems, simulation, surveys): papers live in `papers.yaml`,
